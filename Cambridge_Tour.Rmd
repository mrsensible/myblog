...
<img src="images/book.jpg" alt="drawing" style="width:200px;"/>
...
영국에서 지명 간 거리를 측정하는 기준점(Datum Point)이 처음 세워진 곳이 바로 Great St.Mary 교회이다.

It is unusual for parish churches to have two organs
The ￣ from which the first English milestones were measured in 1732.
