---
title: Why I think nlrx is the best R package for agent-based simulation
author: H
date: '2019-03-18'
slug: hpc
categories: 
...
* `stocond`: When you need stop conditions
...
## Direct codes for ggplot and animation

I presume the developers wanted user to proceed on to their plot works. 
